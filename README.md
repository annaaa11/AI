...
Комп'ютерний зір базується як на класичних алгоритмах, які реаліуються через функції, так і на глибокому навчанні, тобто нейромережах. До основних технологій комп'ютерного зору належать:
